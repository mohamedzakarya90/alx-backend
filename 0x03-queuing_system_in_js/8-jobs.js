/**
 * adding jobs to the queue "push_notification_code_3"
 * @param {Array} jobs -> the list of object which is containing job data
 * @param {import('kue').Queue} queue -> queueing the object
 */
